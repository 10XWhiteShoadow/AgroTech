...
ALLOWED_HOSTS = [
    ...
    for host in os.getenv(
        'ALLOWED_HOSTS',
        'localhost,127.0.0.1,.vercel.app,agrotech-inky-five.vercel.app'
    ).split(',')
    if host.strip()
]
...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'rest_framework',
    # 'django.contrib.postgres',  # Removed: project uses SQLite, not PostgreSQL
]
...
STATIC_URL = 'static/'
# STATICFILES_DIRS only needed if you have a project-level static dir outside apps.
# App-level static files (myapp/static/) are found automatically via APP_DIRS.
